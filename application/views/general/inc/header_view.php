...
<html>
    <head>
        <title><?php echo ucfirst($class) ?> - Sistema para evaluacion de empresas y proveedores</title>
    ...
    <body style="background: #999" onload="MM_preloadImages('<?php echo base_url() ?>/public/img/images/loads-bt_s2.png', '<?php echo base_url() ?>/public/img/images/drivers-bt_s2.png', '<?php echo base_url() ?>/public/img/images/carriers-bt_s2.png', '<?php echo base_url() ?>/public/img/images/customers-bt_s2.png');">
        <div id="container7">
            <div id="header7">
                ...
                <?php if ($user) { ?>
                    <div id="login7"><span class="welcome">hola, <?php echo $user ?></span><br />
            ...
            <div id="menu7" style="background-image: url(<?php echo base_url() ?>/public/img/images/menu-bg.png);">
                <table style="display: inline-table;" border="0" cellpadding="0" cellspacing="0" width="1000">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('empresa'); ?>" onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('loadsbt', '', '<?php echo base_url() ?>/public/img/images/loads-bt_s2.png', 1);"><img name="loadsbt" src="<?php echo base_url() ?>/public/img/images/loads-bt.png" width="120" height="50" id="loadsbt" alt="" /></a></td>
                        <?php
