<div><h2>Editar Evaluacion de Emrpresa <?php echo $empresa['nombre'] ?></h2></div>
<form id="register_form" class="form-horizontal" method="POST" action="<?php echo site_url('empresa/actualizar_test/'.$empresa['idempresa']) ?>">
